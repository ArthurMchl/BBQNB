...
ActiveRecord::Schema.define(version: 2019_11_21_094254) do

ActiveRecord::Schema.define(version: 2019_11_21_093602) do
  ...
  create_table "rentals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["barbecue_id"], name: "index_rentals_on_barbecue_id"
  ...
  add_foreign_key "rentals", "barbecues"
